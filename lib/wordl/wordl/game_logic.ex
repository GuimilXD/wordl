defmodule Wordl.Wordl.GameLogic do
  @moduledoc """
  Documentation for `GameLogic`.
  """

  @doc """
  Calculates the score of a guess in a game of GameLogic.
  ...
  ## Examples
      ...
      iex> GameLogic.score("ALLOW", "LOLLY")
      [:yellow, :yellow, :green, :gray, :grey]

      iex> GameLogic.score("BULLY", "LOLLY")
      [:gray, :grey, :green, :green, :green]

      iex> GameLogic.score("ROBIN", "ALERT")
      [:gray, :grey, :grey, :yellow, :grey]

      iex> GameLogic.score("ROBIN", "SONIC")
      [:gray, :green, :yellow, :green, :grey]

      iex> GameLogic.score("ROBIN", "ROBIN")
